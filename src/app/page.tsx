...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#2d5f3f] via-[#3a7450] to-[#2d5f3f] text-white overflow-hidden">
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#2d5f3f]/95 backdrop-blur-sm border-b border-white/10">
      ...
      <section className="relative min-h-screen flex items-center justify-center py-20 pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 z-10 w-full animate-fade-in">
            ...
            >
              {t.title}
              <span className="block mt-4 bg-gradient-to-r from-green-200 to-emerald-200 bg-clip-text text-transparent">
                {t.titleSecond}
              </span>
            </h1>
            <p
              className={`text-xl sm:text-2xl lg:text-3xl text-green-50 font-medium max-w-full mx-auto lg:mx-0 leading-relaxed ${
                language === "ur" ? "font-urdu" : "font-inter"
              }`}
              dir={language === "ur" ? "rtl" : "ltr"}
            >
              ...
              <div className="relative w-80 h-[650px] lg:w-88 lg:h-[720px] mx-auto">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black rounded-[3rem] shadow-2xl border-8 border-gray-800">
                  ...
                  <div className="absolute inset-x-2 top-2 bottom-2 bg-white rounded-[2.5rem] overflow-hidden">
                    ...
                    {/* App Header */}
                    <div className="h-16 bg-gradient-to-r from-[#2d5f3f] to-[#3a7450] flex items-center justify-between px-4 shadow-md">
                    ...
                    <div className="h-full overflow-y-auto bg-gray-50 pb-20">
                      ...
                      <div className="px-4 py-3 flex gap-2 overflow-x-auto no-scrollbar">
                        <button className="px-4 py-2 bg-[#2d5f3f] text-white text-xs font-semibold rounded-full whitespace-nowrap shadow-sm">
                          {t.availableNow}
                        </button>
                      ...
                      <div className="px-4 pb-4 space-y-3">
                        ...
                        <div className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition">
                          <div className="flex gap-3 p-3">
                            <div className="relative w-24 h-24 flex-shrink-0 rounded-xl overflow-hidden bg-gradient-to-br from-emerald-100 via-green-100 to-emerald-200">
                              <div className="absolute inset-0 flex items-center justify-center">
                                <svg
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-20 right-20 w-96 h-96 bg-emerald-400/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-green-400/10 rounded-full blur-3xl"></div>
        </div>
      </section>

      {/* Footer */}
      <footer className="relative bg-[#1a3d2b] border-t border-white/10 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                />
                <button className="px-4 py-2 bg-white text-[#2d5f3f] rounded-lg font-semibold text-sm hover:bg-green-50 transition">
                  Join
                </button>
              </div>
            </div>
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a
                href="#"
                className="text-green-100/60 hover:text-white transition"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
